...
<div class="card mx-4 mt-6">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('sub.update.type')}}" class="forms-sample" enctype="multipart/form-data">
                                    @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="categories" class="form-control" value="{{$types->categories}}"
                                >
                        </div>
                        <div class="mb-3">
