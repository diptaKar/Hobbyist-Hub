		...
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
				<a href="index.php" class="text-decoration-none">
					<span class="h1 text-uppercase text-primary bg-dark px-2">HOBBYIST</span>
	...
	<div class="container">
		<nav class="navbar navbar-expand-xl" id="navbar">
			<a href="index.php" class="text-decoration-none mobile-logo">
				<span class="h2 text-uppercase text-primary bg-dark">HOBBYIST</span>
      			...
      			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-dark">
							<li><a class="dropdown-item nav-link" href="#">Camra</a></li>
							<li><a class="dropdown-item nav-link" href="#">Lens</a></li>
							<li><a class="dropdown-item nav-link" href="#">Tripod & Stablizeres</a></li>
							<li><a class="dropdown-item nav-link" href="#">Gimbal</a></li>
							<li><a class="dropdown-item nav-link" href="#">Other Accessories</a></li>
						</ul>
					</li>
					<li class="nav-item dropdown">
						<button class="btn btn-dark dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-dark">
							<li><a class="dropdown-item" href="#">T-Shirts & Jackets</a></li>
							<li><a class="dropdown-item" href="#">Trousers & Joggers</a></li>
							<li><a class="dropdown-item" href="#">Bangpacks</a></li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-dark">
							...
							<li><a class="dropdown-item" href="#">Penciles & Pens</a></li>
							<li><a class="dropdown-item" href="#">Colors</a></li>
							<li><a class="dropdown-item" href="#">Brashes</a></li>
							<li><a class="dropdown-item" href="#">Canvases</a></li>
							<li><a class="dropdown-item" href="#">Other Accessories</a></li>
						</ul>
					</li>
