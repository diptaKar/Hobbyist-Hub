            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <picture>
                        ...
                        <img src="{{asset('front-assets/images/bn6.jpg')}}" alt="" />
                    </picture>

                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3">
                            <h1 class="display-4 text-white mb-3">Welcome To HobbistHub</h1>
                            <p class="mx-md-5 px-5">Elevate Joy, Explore Hobbies.</p>
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        ...
                        <img src="{{asset('front-assets/images/bn2.jpg')}}" alt="" />
                    </picture>
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        ...
                        <img src="{{asset('front-assets/images/bn3.jpg')}}" alt="" />
                    </picture>
    ...
    @if(getCategories()->isNotEmpty())
        @foreach(getCategories() as $category)
            <div class="col-lg-3">
                <div class="cat-card">
                    <div class="left">
                        <img src="{{ asset('storage/upload/category_images/'.$category->Photo) }}" alt="" class="img-fluid">
                    </div>
                    <div class="right">
                        <div class="cat-data">
                            <h2>{{ $category->name }}</h2>
                            <!-- <p>{{ $category->product_count }} Products</p> -->
                            <!-- Adjust the attribute names based on your database structure -->
                        </div>
                    </div>
                </div>
            </div>
